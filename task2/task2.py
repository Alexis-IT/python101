...
def result_function(some_dict_list):
    ...
    '''
    result_dict = {}
    dict_info = dict_key_info(some_dict_list)
    #dict_info = dict(sorted(dict_key_info(some_dict_list).items()))        # uncoment if result dict should be sorted by key
...
def run():                                                                # Should we named function run()? In task1 already exist run()
    '''The main function'''
